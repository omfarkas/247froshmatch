 ...
 * 
 * This file contains all student profiles with the complete schema.
 * Add new profiles to the STUDENTS object, then create match pairs in DEMO_MATCHES.
 * 
 * SCHEMA REFERENCE:
 * -----------------
 * Basic Information:
 *   studentId, studentType (F=Freshman, T=Transfer), firstName, prefFirst, middleName,
 *   lastName, sex, genderClarification, height, birthDate, birthPlace
 * 
 * Contact Information:
 *   email, phone, addressLine1, addressLine2, city, state, zip, countryCode, country
 * 
 * Academic Background:
 *   lastSchool, attendedFamily, specialProgram
 * 
 * Room Preferences (1-5 Scale):
 *   prefQuietRoom, roomCleanliness, roomStudy, roomEnvironment, musicImportance, television
 * 
 * Sleep Schedule:
 *   weeknightSleep, weeknightWake, weekendSleep, weekendWake
 * 
 * Music Preferences:
 *   musicPrefer, musicFavorite, musicDontLike
 * 
 * Free Time Activities (Y/N):
 *   socialCultural, socialExercise, socialParties, socialOutdoors, socialRelax,
 *   socialVolunteer, socialOther, socialOtherDetail, religiousPractices, socialArt,
 *   studentClubs, reading, partTimeWork, varsitySport, walkOnSport
 * 
 * Room Usage Plans (Y/N):
 *   roomOvernightGuest, roomListenMusic, roomMeditatePray, roomPractReligion,
 *   roomWatchTv, roomSingInstrument, roomWithFriends, roomVideoGames,
 *   roomTimeAlone, roomArtWork, roomCallFamily
 * 
 * Other Information:
 *   foodAllergy, foodAllergyDetail, religiousNeed, smoking, isoAttendance,
 *   isoAttendanceReason, isoStatus
 * 
 * Gender & Housing:
 *   identifyAs, preferredRoomGender, preferredRoomGenderExplained
 * 
 * Written Responses:
 *   optimalVibe, concerns
 * 
...
export const STUDENTS = {
  joeyChestnut: {
    ...
    optimalVibe: `I'm definitely an early bird—I'm up at 5am every morning to hit the gym before classes. I love having a calm and focused space where I can get my work done during the week. I like to keep things pretty quiet on weeknights since I'm usually in bed by 9:30pm. I love listening to music while I clean or just hang out, but I always keep the volume at a level where we can still have a conversation. Having a roommate with a similar early schedule would make things way easier for both of us!`,
  ...
  steveIrwin: {
    ...
    preferredRoomGender: 'Male-identifying',
    preferredRoomGenderExplained: '',
    optimalVibe: `I'm a total early bird—I love watching the sunrise and getting my day started before anyone else is awake. I thrive in a calm, organized environment and do my best studying either in complete silence or with some chill lo-fi beats in the background. I'm usually in bed by 9:30pm and up at 5am to start my morning routine with meditation and exercise. Having a consistent sleep schedule is really important to me because I tend to get cranky when I'm sleep-deprived. I'm not a party person by any means, but I do enjoy having meaningful conversations and just relaxing in the room after a long day.`,
...
/**
 * Demo match pairs for the roommate matching flow.
 * Each pair contains references to students from the STUDENTS object.
 */
export const DEMO_MATCHES = [
  {
    student1: STUDENTS.joeyChestnut,
    student2: STUDENTS.steveIrwin,
  },
  {
    student1: STUDENTS.barackObama,
    student2: STUDENTS.mittRomney,
  },
  {
    student1: STUDENTS.taylorSwift,
    student2: STUDENTS.sabrinaCarpenter,
  },
];
